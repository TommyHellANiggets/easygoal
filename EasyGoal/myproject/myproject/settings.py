...
SECRET_KEY = 'django-insecure-9lo8lrd!@y-38^#(7dl-pjjbs_ufk#dl3zukz1kt949=jv^%t5'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'EasyGoal',  # Имя вашей базы данных
        'USER': 'root',        # Имя пользователя MySQL
        'PASSWORD': '12345678',# Пароль пользователя MySQL
